...
variable "engine_version" {
  ...
  validation {
    condition     = can(regex("^(14|15|16|17|18)(\\.[0-9]+)*$", var.engine_version))
    error_message = "Engine version must be a valid PostgreSQL version (14-18) with optional patch version."
  }
}
